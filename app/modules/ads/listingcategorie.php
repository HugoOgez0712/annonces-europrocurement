...
class listingcategorie extends \App\views\Genere_views {
    ...
    public function process($request, $response) {
        ...
        if($page > 0 && $page > $nbPage){
            return $this->redirect($request, $response, 301, 'ads.listingcategorie',['page' => $nbPage, 'cat_slug' => $cat_slug]);
        }

        $url = $this->container->get('router')->pathFor('ads.listingcategorie',$paramroute);
        ...
        return $this->render($request,$response, 'ads/listingcategorie');
