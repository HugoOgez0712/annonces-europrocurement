    ...
    <div class="row">
        <div class="col-lg-8 col-md-12 content annonce-wrapper">
            ...
            <div class="bread col-12">
                    ...
                    <span><a href="<?= $router->pathFor('ads.listingcategorie',['cat_slug'=>$cat->cat_slug]) ?>"><?= $cat->cat_nom ?></a></span>
                    <span><a href="<?= $router->pathFor('ads.listingcategorieville',['cat_slug'=>$cat->cat_slug, 'ann_geoloc'=>$ville]) ?>"><?= $ville ?></a></span>
                </div>
            </div>
            <div class="row">
                <div class="col-12">
                    <div class="annonces-titre">
                        <h1 class="serif">Annonces <?= $cat->cat_nom ?> à <?= $ville ?></h1>
