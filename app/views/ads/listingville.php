    ...
    <div class="row">
        <div class="col-lg-8 col-md-12 content annonce-wrapper">
            ...
            <div class="bread col-12">
                    ...
                    <span><a href="<?= $router->pathFor('ads.listingville',['ann_geoloc'=>$ville]) ?>"><?= $ville ?></a></span>
                </div>
            </div>
            <div class="row">
                <div class="col-12">
                    <div class="annonces-titre">
                        <h1 class="serif">Annonces à <?= $ville ?></h1>
                        <a href="<?= $site_full_url ?>/annonces-legales/" class="btn medium blue-medium-border">Publier</a>
                    </div>
                </div>
            </div>
            <?php
